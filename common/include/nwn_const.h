...
#define ENGINE_STRUCTURE_ARRAY 5
#define ENGINE_STRUCTURE_DBRESULT 6
#define ENGINE_STRUCTURE_DICTIONARY 7

#define CGOA_RET_SUCCESS 		0
#define CGOA_RET_BAD_ID 		1
#define CGOA_RET_NULL_OBJECT 	4

#define VARTYPE_INT 		1
#define VARTYPE_FLOAT 		2
#define VARTYPE_STRING 		3
#define VARTYPE_OBJECT 		4
#define VARTYPE_LOCATION 	5

#define CNWSObject_ACTION_IN_PROGRESS 1
#define CNWSObject_ACTION_COMPLETE 2
#define CNWSObject_ACTION_FAILED 3
