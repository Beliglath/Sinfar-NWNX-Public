...
{
	int unk_0x0[40];
	int reload_module_when_empty; //0x0a0
	int unk_0xa4;
	int unk_0xa8;
	int unk_0xac;
	int max_char_level; //0x0b0
	int min_char_level; //0x0b4
	int unk_0xb8[11];
	int pvp_setting; //0x0e4
	int pause_and_play; //0x0e8
	int only_one_party; //0x0ec
	int enforce_legal_characters; //0x0f0
	int item_level_restriction; //0x0f4
	int cd_banned_behavior; //0x0f8
	int disallow_shouting; //0x0fc
	int show_dm_joined; //0x100
	int backup_saved_chars; //x0104
	int failure_on_1; //0x108
	int validate_spells; //0x10c
	int examine_effects_on_creatures; //x110;
	int examine_cr_on_creatures; //0x114
	int max_hit_points; //0x118
	int restore_spell_uses; //0x11c
	int always_reset_encounter_spawns; //0x120
	int hide_hit_points_gained; //0x124
	int unk_0x128[13];
	CExoString description;
	int game_type; //0x164
	int unk_0x168;
	int unk_0x16c;
	int difficulty_level; //0x170
};
...
struct CServerExoAppInternal_s {
    ...
    CServerInfo*           		server_settings;        /* 1000C */
    ...
    CExoArrayList<uint32_t>    *field_1002C;            /* 1002C */
    ...
    CExoArrayList<uint32_t>    *field_100F0;            /* 100F0 */

    CExoArrayList<void*>       *field_100FC;            /* 100FC (CExoString) */
    CExoArrayList<void*>       *field_10108;            /* 10108 (CExoString) */
    CExoArrayList<void*>       *field_10114;            /* 10114 (CExoString) */
    ...
    CExoArrayList<void*>       *field_10130;            /* 10130 (SSubNetProfile *) */
