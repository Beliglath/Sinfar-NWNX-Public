...
struct CNWSCreature_s {
    ...
    CExoArrayList<uint32_t>     cre_aoe_list;           /* 02EC */
    CExoArrayList<uint32_t>     cre_subarea_list;       /* 02F8 */

    nwn_objid_t                 cre_blocked_id;         /* 0304 */
    CPathfindInformation*       cre_pathfinding;        /* 0308 */
    ...
    CExoArrayList<uint32_t>     cre_action_queue;       /* 036C */
    ...
    void**                   	cre_automap_tile_data;  /* 0490 */
    CExoArrayList<uint32_t>     cre_automap_areas;      /* 0494 */
    ...
    CExoArrayList<uint32_t>     cre_effect_icons;       /* 09E8 */
    ...
    CExoArrayList<void*>        cre_percepts;           /* 0A30 */
    ...
    CExoArrayList<uint32_t>     *cre_party_invites;      /* 0A4C */
    ...
    CExoArrayList<uint32_t>     cre_spell_identified;   /* 0A60 */
    ...
    int                         cre_display_name_update;/* 0B08 */
    ...
    CExoArrayList<uint32_t>    *cre_associates;         /* 0B38 */
    ...
    CExoArrayList<uint32_t>    *cre_reputation_personal;/* 0B5C */
    CExoArrayList<uint32_t>    *cre_reputation;         /* 0B60 */

    CExoArrayList<uint32_t>    *cre_pvp;                /* 0B64 */
    ...
    uint32_t                    field_C34;
    uint32_t                    field_C38;
    uint16_t                    cre_last_appearance;
	uint8_t                     field_C3E;
	uint8_t                     cre_last_gender;
    uint32_t                    field_C40;
    uint32_t                    field_C44;
    uint32_t                    field_C48;
    uint32_t                    field_C4C;
